...
export const TechStackSection = () => {
  return (
    <section className="py-28 relative overflow-hidden noise-overlay">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[radial-gradient(ellipse_at_center,hsl(145_70%_45%/0.05),transparent_70%)]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Modern technologies powering scalable and high-performance digital platforms.
          </p>
        </motion.div>
        ...
        >
          {technologies.map((tech) => (
            ...
            >
              <div className="absolute -inset-0.5 rounded-2xl opacity-0 group-hover:opacity-30 blur-md transition-all duration-500 bg-primary" />
              <div className="relative glass-card p-5 text-center h-full border border-border/50 group-hover:border-primary/30">
                <div
                  className="w-12 h-12 mx-auto mb-3 rounded-xl flex items-center justify-center text-lg font-bold transition-transform group-hover:scale-110"
