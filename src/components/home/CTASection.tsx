...
export const CTASection = () => {
  return (
    <section className="py-28 relative overflow-hidden noise-overlay">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,hsl(145_70%_45%/0.08),transparent_70%)]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" asChild className="group px-8 hover:shadow-[0_0_25px_-5px_hsl(145_70%_45%/0.4)]">
