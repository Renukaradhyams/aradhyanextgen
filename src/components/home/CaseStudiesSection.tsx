...
export const CaseStudiesSection = () => {
  return (
    <section className="py-28 relative overflow-hidden noise-overlay">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[radial-gradient(ellipse_at_center,hsl(145_70%_45%/0.04),transparent_70%)] translate-x-1/4" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Real businesses powered by Aradhya NextGen. Built for performance, scalability, and measurable growth.
          </p>
        </motion.div>
        ...
        >
          {projects.map((project) => (
            ...
            >
              <div className="absolute -inset-0.5 bg-primary rounded-2xl opacity-0 group-hover:opacity-20 blur-sm transition-all duration-500" />
              ...
              <div className="relative glass-card overflow-hidden h-full border border-border/50 group-hover:border-primary/30">
                ...
                <div className={`h-40 bg-gradient-to-br ${project.gradient} relative overflow-hidden`}>
                  ...
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,hsl(var(--foreground)/0.05)_1px,transparent_0)] bg-[size:24px_24px]" />
